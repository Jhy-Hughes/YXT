...
hospitals_dengji_nanjing = ["江苏省人民医院","南京市中医院","南京鼓楼医院","南京市中心医院","南京市儿童医院"]
# drugs_dengji = ["展筋活血散","甘海胃康胶囊0.4g×120粒","妇炎舒胶囊0.4g×60粒","妇炎舒胶囊0.4g×96粒","妇炎舒胶囊0.4g×48粒","黄龙咳喘胶囊","黄龙止咳颗粒"]             
hospitals_jiceng_nanjing = ["南湖社区卫生服务中心","百家湖社区卫生服务中心","玄武湖社区卫生服务中心","玄武区后宰门社区卫生服务中心","红山社区卫生服务中心"]
hospitals_lishou = ["益丰大药房","先声再康大药房","老百姓大药房","奇冠药店"]

hospitals_jiceng = ["南湖社区卫生服务中心","百家湖社区卫生服务中心","玄武湖社区卫生服务中心","玄武区后宰门社区卫生服务中心","红山社区卫生服务中心"]

drugs_dengji = ["雷贝拉唑钠肠溶胶囊20mg×14粒","三拗片0.5g×24片","健胃消食口服液10ml×12支","川芎清脑颗粒10g×10袋",
...
#             by=By.XPATH, value="//tbody/tr[1]/td[2]/span/span/span/span").click()
#         sleep(2)
#         driver.find_element(by=By.XPATH, value="//input[@class='select2-search__field']").send_keys(
#             hospitals_jiceng[hospital_id_5])
#         sleep(2)
#         driver.find_element(
...
#         driver.find_element(
#             by=By.XPATH, value="//tbody/tr[1]/td[12]/input").clear()
#         driver.find_element(
#             by=By.XPATH, value="//tbody/tr[1]/td[12]/input").send_keys(str(people_number))
...
#         time.sleep(2)
#         driver.find_element(by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(
#             hospitals_linchuang[id_i_linchuang])
#         sleep(2)
#         driver.find_element(
#             by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(Keys.ENTER)
...
#         # 产品名(修改)todo：8.15
#         driver.find_element(
#             by=By.XPATH, value="//tr[@role='row']/td[7]/span/span[1]").click()
#         time.sleep(3)
...
#         time.sleep(2)
#         product_chanpin = [1, 4]
#         driver.find_element(by=By.XPATH, value="//ul[@class='select2-results__options']/li[%d]" % (product_chanpin[i % 1])).click()
...
#         sleep(3)
#         driver.find_element(by=By.XPATH, value="//ul[@id='select2-CompanyProductName-results']/li[%d]" % (productnumber[i % 3])).click()
#         sleep(1)
...
while i < 9:
    try:
        ...
        # productnumber = [1, 2, 3, 5,6,8,9,10,11,12,13]
        # product_index = [5, 4, 5,6,5,4,3,4,4,7,3]
...
while i < 15:
    try:
        ...
        driver.find_element(by=By.XPATH, value="//tbody/tr[1]/td[5]/span/span/span").click()
        sleep(2)
        driver.find_element(by=By.XPATH, value="//ul[@class='select2-results__options']/li[4]").click()
        # driver.find_element(by=By.XPATH, value="//ul[@class='select2-results__options']/li[1]").click()
        ...
        # 月均用药潜力数量
        month_use = random.randint(1,7)*10
