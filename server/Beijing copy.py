...
# 13691411386
# 13179475866
driver.find_element(by='name',value='usernameOrEmailAddress').send_keys('13683379957')
...
# 服务计划
driver.find_element(by=By.XPATH, value="//tbody/tr[2]/td[1]/label/span").click()
time.sleep(5)
...
while i < 15 :
    try:
        ...
        sleep(2)
        driver.find_element(by=By.XPATH, value="//ul[@class='select2-results__options']/li[%d]"%(5 - i % 5)).click()
        sleep(1)
        ...
        # 月均用药潜力数量
        month_use = random.randint(1,6)*10
...
while i < 20:
    ...
    try :
        ...
        driver.find_element(by=By.XPATH, value="//tbody/tr[1]/td[12]/input").clear()
        driver.find_element(by=By.XPATH, value="//tbody/tr[1]/td[12]/input").send_keys(str(random.randint(20,65)))
