...
# 服务计划
driver.find_element(by=By.XPATH, value="//tbody/tr[10]/td[1]/label/span").click()
time.sleep(5)
...
hospitals_dengji_nanjing = [ "句容市人民医院", "句容市中医院", "丹阳市第二人民医院", "镇江市第四人民医院","江苏大学附属医院","镇江市中医院",  "镇江市第一人民医院", "丹阳市人民医院", "丹阳市第二人民医院","镇江市第二人民医院"]
...
# drugs_dengji = ["小儿豉翘清热颗粒2g（无蔗糖）×9袋","小儿豉翘清热颗粒2g（无蔗糖）×6袋","三拗片0.5g×24片","小儿豉翘清热颗粒4g（无蔗糖）×6袋","蒲地蓝消炎口服液10ml(相当于饮片10.01g)×10支","健胃消食口服液10ml×12支"]
drugs_dengji = ["展筋活血散","甘海胃康胶囊0.4g×120粒","妇炎舒胶囊0.4g×60粒","妇炎舒胶囊0.4g×96粒","妇炎舒胶囊0.4g×48粒","黄龙咳喘胶囊","黄龙止咳颗粒"]             

hospitals_jiceng_nanjing = ["大市口社区卫生服务中心","京口区象山卫生服务中心","宝塔路社区卫生服务中心","润州区黎明社区卫生服务中心","四牌楼社区卫生服务中心","蒋乔社区卫生服务中心","大港社区卫生服务中心"]
...
#         sleep(1)
#         driver.find_element(by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(hospitals_dengji_nanjing[hospital_id_1])
#         sleep(2)
...
# #         drugs_id_4 = i % 5
# #         if(hospital_id_4==2):
# #             sale_money = random.randint(40,60)*100
# #             last_number = random.randint(20,30)
# #             drugs_id_4 = 2
# #         elif(hospital_id_4==0):
# #             drugs_id_4 = 1
# #             sale_money = random.randint(30,60)*100
# #             last_number = random.randint(10,20)
# #         else :
# #             sale_money = random.randint(4,9)*100
# #             last_number = random.randint(5,15)
...
# time.sleep(8)
hospitals_special = ["句容市妇幼保健院","镇江市江滨医院", "句容市人民医院",  "镇江市第四人民医院"]
...
#             by=By.XPATH, value="//tbody/tr[1]/td[2]/span/span/span/span").click()
#         time.sleep(2)
#         driver.find_element(by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(hospitals_special[i//10])
#         time.sleep(3)
#         driver.find_element(
#             by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(Keys.ENTER)
...
#         # 产品名(修改)todo：8.15
#         driver.find_element(by=By.XPATH, value="//tr[@role='row']/td[7]/span").click()
#         sleep(2)
#         # driver.find_element(by=By.XPATH, value="//*[@id='select2-productNames-results']/li[%d]" % (random.randint(1,5))).click()
#         driver.find_element(by=By.XPATH, value="//*[@id='select2-productNames-results']/li[1]").click()

        
#         # driver.find_element(by=By.XPATH, value="//tr[@role='row']/td[7]/span/span[1]").click()
#         time.sleep(3)
...
#         driver.find_element(by=By.XPATH, value="//ul[@class='select2-results__options']/li[%d]" % (product_chanpin[0])).click()
...
#         driver.find_element(by=By.XPATH, value="//span[@class='select2-dropdown select2-dropdown--below']/span[2]/ul/li[4]").click()
...
#         time.sleep(1)
#         driver.find_element(by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(hospitals_special[i // 5])
#         sleep(4)
#         driver.find_element(by=By.XPATH, value="//span[@class='select2-search select2-search--dropdown']/input").send_keys(Keys.ENTER)
...
# drugs_pinpai_cailiao = ['甘海胃康胶囊-样宣','妇炎舒胶囊-样宣']
while i < 20 :
    try:
        # 新建
        driver.find_element(by='id', value='CreationReport').click()
        ...
        # driver.find_element(by=By.XPATH, value="//tbody/tr[1]/td[9]/span/span/span").click()
...
while i < 10:
    try:
        ...
        # productnumber = [1, 3 ,4]        
        productnumber = [1, 2, 3, 5]
        product_index = [5, 4, 5,6]
        if i >= sum:
            IndexNum = IndexNum + 1
